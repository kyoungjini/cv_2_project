...
if __name__=="__main__":
    test_male_recommended = {
        "upper":[f"../data/laurant051/features/{i}.pt" for i in range(0, 5+1)],
        "lower":[f"../data/laurant051/features/{i}.pt" for i in range(6, 10+1)],
    }
    test_female_recommended = {
        "upper": [f"../data/slowand/features/{i}.pt" for i in range(0, 5+1)],
        "lower": [f"../data/slowand/features/{i}.pt" for i in range(6, 14+1)],
    }
    ...
    topk, similarity_result = model(user_inputs, "upper", "male")
    print(topk)
    print("\n")
